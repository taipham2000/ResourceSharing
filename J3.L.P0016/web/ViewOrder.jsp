            ...
            <div class="container">
                <header id="masthead" class="site-header">
                    <div class="site-branding">
                        <h1 class="site-title"><a href="index.html" rel="home"> VIEW ORDER</a></h1>
                    </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>${cart.sanpham.productID}</td>
                                            <td><img src="images/${cart.sanpham.imageUrl}"></td>
                                            <td>${cart.sanpham.productName}</td>
                                            <td>${cart.quantities}</td>
                                        </tr>
                                        </c:forEach>
                                    <td><h1><a href="MainController?action=Borrow"/>Borrow</h1></td>
                                    </tbody>
                                </table>
                            </form>
